...
function Body($title)
{
    ...
    "));
    $this->Ln(1);//<b>Calle</b>
    $this->WriteHTML(utf8_decode("                              La Dirección de la Escuela de Educación Secundaria Técnica N°1 Raúl Scalbrini Ortiz del distrito de La Costa, <b>CONCEDE</b> el pase al alumno ".$nombre." con DNI N°".$dni.", quien cursó ".$curso."°año división ".$division.", del Plan de Estudio de <b>Secundaria, Ciclo Superior</b>, Resolución N° <b>$resolucion</b>; en el Ciclo lectivo 2021.  ")) ;
    $this->Ln(10);
    $this->WriteHTML(utf8_decode("Materias pendientes:".$comentario."")) ;
    $this->Ln(10);
    $this->WriteHTML(utf8_decode("                   Se extiende el presente en la ciudad de Santa Teresita, a los ".$dia." días del mes ".$mes." de ".$anio.".-")) ;
    $this->Ln(5);
