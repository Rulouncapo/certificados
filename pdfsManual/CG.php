...
function Body($title)
{
    ...
    $this->SetX(65);
    $this->Ln(1);//<b>Calle</b>
    $this->WriteHTML(utf8_decode("                    La Dirección de la Escuela de Educación Secundaria Técnica N°1 Raúl Scalabrini Ortíz de Santa Teresita, Partido de La Costa, deja constancia que <b>$nombre</b>, con DNI ".$dni." cursa en este establecimiento educativo el ".$curso."° año de la Escuela Secundaria Superior Técnica, en la orientación ".$orientacion.", en el presente Ciclo Lectivo. ")) ;
    $this->Ln(10);
    $this->WriteHTML(utf8_decode("                    El Plan de estudios del nivel Secundarios de este Establecimiento es de 7 años.")) ;
    $this->Ln(10);
    $this->WriteHTML(utf8_decode("                    Se extiende la presente a pedido del/la interesado/a en Santa Teresita, a los ".$dia." días del mes ".$mes." de ".$anio.", para ser presentada a quien corresponda. ")) ;
    $this->Ln(5);
    $this->SetFont('Arial','',14);
    $this->SetXY(40,230); 
