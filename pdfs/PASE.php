...
function Body($title)
{
    ...
    "));
    $this->Ln(1);//<b>Calle</b>
    $this->WriteHTML(utf8_decode("                              La Dirección de la Escuela de Educación Secundaria Técnica N°1 Raúl Scalbrini Ortiz del distrito de La Costa, <b>CONCEDE</b> el pase al alumno ".$nombre." con DNI N°".$dni.", quien cursó ".$grado."°año división ".$division.", del Plan de Estudio de <b>Secundaria, Ciclo Superior</b>, Resolución N° <b>$resolucion</b>; en el Ciclo lectivo 2021.  ")) ;
    $this->Ln(10);
